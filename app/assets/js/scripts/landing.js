...
function asyncSystemScan(mcVersion, launchAfter = true){
        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    ...
                    'Pour rejoindre ZendLand, vous avez besoin d\'une installation 64 bits de Java 8. Souhaitez-vous que nous installions une copie ?',
                    'Installer Java',
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            'Java est requis<br>pour démarrer',
                            'Une installation x64 valide de Java 8 est requise pour démarrer.<br><br>Veuillez vous référer au <a href="https://github.com/dscalzi/HeliosLauncher/wiki/Java-Management#manually-installing-a-valid-version-of-java">Guide de gestion Java</a> pour obtenir des instructions sur l\'installation manuelle de Java.',
                            'Je comprends',
                            'Retour'
                        )
                        setOverlayHandler(() => {
            ...
            if(m.result === true){
                ...
                setOverlayContent(
                    ...
                    'Malheureusement, nous avons rencontré un problème lors de la tentative d\'installation de Java. Vous devrez installer manuellement une copie. Veuillez consulter le <a href="https://github.com/dscalzi/HeliosLauncher/wiki">Guide de dépannage</a> pour plus de détails et d\'instructions.',
                    'Je comprends'
                )
                setOverlayHandler(() => {
                    toggleOverlay(false)
    ...
    setLaunchDetails('Vérification des info système...')
...
function dlAsync(login = true){
        ...
        if(m.context === 'validate'){
            switch(m.data){
                ...
                case 'version':
                    ...
                    setLaunchDetails('Validation de des actifs...')
                    break
                case 'assets':
            ...
            if(login && allGood) {
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        ...
                        DiscordWrapper.updateDetails('Joue sur ZendLand !')
                    }
                }
                ...
                try {
                    ...
                    setLaunchDetails('Terminé. Profitez de ZendLand !')
    ...
    setLaunchDetails('Chargement des infos serveur...')
...
function setNewsLoading(val){
    if(val){
        const nLStr = 'Recherche d\'actualité'
        let dotStr = '...'
